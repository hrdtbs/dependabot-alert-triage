...
function makeAlertReport(overrides?: Partial<AlertReport>): AlertReport {
  return {
    alert: {
      ...
      cvssV4: null,
      epss: 0.032,
      cwes: [{ cweId: "CWE-94", name: "Improper Control of Generation of Code ('Code Injection')" }],
      firstPatchedVersion: "4.17.21",
      dependencyScope: "runtime",
      htmlUrl: "https://github.com/my-company/app/security/dependabot/1",
    },
    kev: false,
    epss: 0.032,
    codeSearch: {
      ...
      makeRepo("my-company/api", [
        makeAlertReport({
          alert: {
            ...
            dependencyScope: "runtime",
            htmlUrl: "https://github.com/my-company/api/security/dependabot/2",
          },
          kev: true,
          epss: 0.85,
        }),
