...
- [ ] Initialize Tauri v2 project structure (Rust + React/TypeScript).
- [ ] Configure Vite, Tailwind CSS, and shadcn/ui.
- [ ] Set up linting and formatting (ESLint, Prettier, Rustfmt, Clippy).
- [ ] Define project architecture (folder structure for frontend/backend).
